...
// --- MISSING CSS IMPORTS ADDED HERE ---
...
const Achievements = () => {
  ...
  return (
    ...
    <section
      id="achievements"
      className="py-20 bg-white dark:bg-slate-900 text-slate-800 dark:text-slate-300 scroll-mt-32"
    >
      ...
      <div className="container mx-auto px-4"> 
        {/* Added px-4 container padding to prevent cards touching edges */}
        <Slider {...settings}>
