...
// import { Link as RouterLink } from 'react-router-dom'; // a. IMPORT REACT ROUTER LINK
...
//           {/* b. ADDED BLOG ROUTER LINK (DESKTOP) */}
//           <RouterLink
//             to="/blog"
//             className="cursor-pointer hover:text-sky-600 dark:hover:text-sky-400 transition duration-300 hover:scale-105"
//           >
//             Blog
//           </RouterLink>
...
//             {/* c. ADDED BLOG ROUTER LINK (MOBILE) */}
//             <RouterLink
//               to="/blog"
//               onClick={() => setIsMenuOpen(false)}
//               className="block py-2 px-3 text-base text-slate-800 dark:text-slate-200 hover:text-sky-600 dark:hover:text-sky-400 transition"
//             >
//               Blog
//             </RouterLink>
//           </div>
